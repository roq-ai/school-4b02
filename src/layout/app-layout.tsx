...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'It Staffs', path: '/it-staffs', entity: 'it_staff', service: AccessServiceEnum.PROJECT, icon: FiUserX },
    { name: 'Parents', path: '/parents', entity: 'parent', service: AccessServiceEnum.PROJECT, icon: FiUserMinus },
